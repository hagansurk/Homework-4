...
for persons in people:
	person = persons.find('div', {'property':'dc:title'})
	name = person.string
	title = persons.find('div', {'class':'field field-name-field-person-titles field-type-text field-label-hidden'})
	position = title.string
	umsi_titles[name] = position
print(umsi_titles)
